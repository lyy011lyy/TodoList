package com.example.yalin.photogalleryactivity;
...
public class FlickrFetchr {
    ...
    public static final String API_KEY = "f52aa08dbba713e9d1b20aaaa2ddb47f";
    public static final String METHOD_GET_RECENT = "flickr.photos.getRecent";
    public static final String METHOD_GET_SEARCH = "flickr.photos.search";
    ...
    public ArrayList<GalleryItem> downloadGallaryItems(String url) {
